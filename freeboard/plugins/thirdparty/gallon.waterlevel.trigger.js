...
(function() {
    freeboard.loadWidgetPlugin({
        type_name: 'waterlevel-trigger',
        display_name: 'Water Level Trigger',
        description: '',
        fill_size: false,
        'external_scripts': [
        ...
        settings: [
            ...
            {
                name: 'submitUrl',
                display_name: 'Submit URL',
                type: 'text',
                description: 'This widget will make POST request when you add an action',
            },
            {
                name: 'deleteUrl',
                display_name: 'Delete URL',
                type: 'text',
                description: 'This widget will make POST request when you delete an action',
            }
        ],
        ...
        this.render = function render(containerElement) {
            ...
            $('body').on('click', '#glx-trigger-waterlevel-' + currentSettings.uniqueid + ' .glx-add-action', function(event) {
                ...
                freeboard.showDialog($formElement, 'Add new Action', 'Save', 'Cancel', function() {
                    ...
                    payload.action.alias = $formElement.find('[name="contactName"]').val();
